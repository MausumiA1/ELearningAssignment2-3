...
public class CreateCoursePOM {
	...
	public WebElement getCategory(){
		this.category.click();
		selCategory=this.allCategory.get(1);
...
//	}
	...
	public String setCategory(WebElement category)
	{
	...
	public String setTeachers(String teacher) {
		...
		teacherName=teacherSel.getText();
	...
	public CourseListPOM clickCreateCourseBtn() {
		this.createCourseBtn.click(); 
		return new CourseListPOM(driver);
	}	
}
